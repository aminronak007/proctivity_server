...
class CreateCustomerDocumentsTable {
  constructor() {}

  async create(prefix) {
    try {
      const migration_name = prefix + "CreateCustomerDocumentsTable";
      const [rows, fields] = await connectPool.query(
        "select id from migrations where name=?",
        [migration_name]
      );

      let table_name = prefix + "customer_documents";
...
module.exports = new CreateCustomerDocumentsTable();
